...
const cards = [
  {
    ...
    description:
      "Optimize copy with research, replicate a proven funnel structure, or apply CRO patterns to improve conversion.",
  ...
  },
  {
    ...
    description:
      "Open and continue previous CRO projects, view outputs, and export optimized funnels.",
...
export default function NewFunnelDashboardPage() {
  return (
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              CRO Agent — optimize copy with customer research, replicate proven funnel structures, and apply conversion patterns.
            </p>
          </div>
        </div>
      </div>
